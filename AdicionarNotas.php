...
?> </h1>
 ...
 <div>
<ul id="menu">
 <li style="position:absolute; left: 1px; top: 600px;"><a href="listaralunos.php">Voltar A Página do Professor </a> </li>
 </ul>
</div>
...
<form action="AdicionarNotas.php" method="POST" >

			
			<table border="2px" style="position:absolute; left: 200px; top: 200px;" bordercolor="#009966">
    	<tr>
        	<td align="center">CODIGO</td>
            <td align="center">MEDIA</td>
            <td align="center">DISCIPLINA codigo</td>
            <td align="center">ALUNO CODIGO</td>
            ...
            <td> <input   type="text" id="media" name="media"/>        </td>
            <td> <input    type="text" id="disciplina" name="disciplina"/>   </td>
            <td> <input   type="text" id="aluno" name="aluno"/>      </td>
